...
export class MallApi{
    ...
    goodstypelist(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'mall/goodstypelist',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    storeinfo(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'mall/storeinfo',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    storelist(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'mall/storelist',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
