...
export class GiftcardsApi{
    ...
    buygiftcardlist(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'giftcards/buygiftcardlist',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    exchangecard(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'giftcards/exchangecard',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    mygiftcardinfo(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'giftcards/mygiftcardinfo',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    mygiftcardlist(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'giftcards/mygiftcardlist',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    sendmember(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'giftcards/sendmember',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    zhengsongjilu(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'giftcards/zhengsongjilu',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
